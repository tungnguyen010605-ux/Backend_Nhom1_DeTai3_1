...
- [ ] Dựng avatar rig và hệ IK có thể nhận dữ liệu pose.
...
- [ ] Có tài liệu setup Unity + XR package version.
...
- [ ] Gọi API backend từ Unity.
- [ ] Nhận task_id và theo dõi trạng thái (polling hoặc websocket).
- [ ] Download texture và apply vào material avatar.
- [ ] Xử lý retry, timeout, fallback UI.

Tiêu chí hoàn thành (Definition of Done - Phase C)
- [ ] End-to-end demo: chọn user -> pose -> gọi fitting -> avatar mặc được texture mới.
- [ ] Có log và màn hình status rõ ràng trong Unity.
- [ ] Có checklist UAT cho nhóm.
